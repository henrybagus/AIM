...
$(function(){ App.init(); });
/*
$('#tglMulai2').datepicker({weekStart: 1, startDate: 'd', format: 'dd M yyyy'});
$('#tglAkhir2').datepicker({weekStart: 1, startDate: 'd', format: 'dd M yyyy'});
*/

/*
function date_cek(){
	var tglMulaijs = new Date($('#tglMulai2').val());
	var tglAkhirjs = new Date($('#tglAkhir2').val());
	var tempAwal = tglMulaijs.getDate() + '/' + (tglMulaijs.getMonth() + 1) + '/' +  tglMulaijs.getFullYear();
	var tempAkhir = tglAkhirjs.getDate() + '/' + (tglAkhirjs.getMonth() + 1) + '/' +  tglAkhirjs.getFullYear();
	tempAwal = Date.parse(tempAwal)/1000;
	tempAkhir = Date.parse(tempAkhir)/1000;
	if(tempAwal > tempAkhir){
		alert("Periode tanggal akhir publikasi kuesioner melewati tanggal awal");
		return false;
	}else{
		return true;
	}
...
//var dateB = new Date($('#tglBeres1').val());
//var tempDateB = dateB.getDate() + '/' + (dateB.getMonth() + 1) + '/' +  dateB.getFullYear();
//alert(tempDateB);
$('#tglMulai').datepicker({
	weekStart: 1, 
	startDate: 'd', 
