...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Sistem Informasi AIM</title>
        ...
        <link href="<?=base_url('assets/layouts/layout/css/themes/blue.min.css')?>" rel="stylesheet" type="text/css" />
    ...
    <!-- END HEAD -->
    <body class="page-header-fixed page-footer-fixed page-sidebar-closed-hide-logo page-content-white"> <!-- tutup di footer -->
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo" style="padding:0px">
                        <a href="<?=base_url()?>" style="color:#CCC">
                            <img src="<?=base_url('assets/img/logo.jpg')?>" alt="logo" class="logo-default" style="width:50px;margin:0px" />
                            <span>Abadi Inti Makmur</span>
                        </a>
                        ...
                        <ul class="nav navbar-nav pull-right">
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="<?=base_url('assets/layouts/layout/img/newuserjs.png')?>" />
                                ...
                                <ul class="dropdown-menu" style="width:275px">
                                   <li>
                                        <a href="javascript:;">
                                            ...
                                            <?php  echo $this->session->userdata('group_nameAktif')  /*
